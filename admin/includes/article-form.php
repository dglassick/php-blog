...
<form id='formArticle' method="post">
    ...
    <div class="input-group mb-3">
        <label class="input-group-text" for="published_at">Publication date and time</label>
        <input autocomplete="off" class="form-control" type="text" name="published_at" id="published_at" value="<?= htmlspecialchars($article->published_at); ?>">
    </div>
